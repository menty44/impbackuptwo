...
public class TransactionQuery  implements java.io.Serializable {
    ...
    private com.flocash.www.Query query;
    ...
    /**
     * Gets the authentication value for this TransactionQuery.
     * 
    ...
    /**
     * Sets the authentication value for this TransactionQuery.
     * 
    ...
    /**
     * Gets the query value for this TransactionQuery.
     * 
     * @return query
     */
    public com.flocash.www.Query getQuery() {
        return query;
    }


    /**
     * Sets the query value for this TransactionQuery.
     * 
     * @param query
     */
    public void setQuery(com.flocash.www.Query query) {
        this.query = query;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.flocash.com", ">TransactionQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.flocash.com", "Query"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
