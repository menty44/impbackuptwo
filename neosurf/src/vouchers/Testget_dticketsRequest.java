...
public class Testget_dticketsRequest {
	
try {
    	
    	String currency = "EUR";
        String IDProduct = "4";
        String IDReseller = "impalapay.reseller.prod@neosurf.com+soied98x3edtrq";
        String IDTransaction = "TRX002";
        String IDUser = "226";
        String quantity = "1";
        String distributorSecretKey = "lheof54f54sg1e3gg7gjhgdsfluvgejg";
        ...
        */
		...
		String resp = rp.getSOAPPart().getElementsByTagName("faultcode").item(0).getFirstChild().getNodeValue(); 
		System.out.println("");
		String resp1 = rp.getSOAPPart().getElementsByTagName("faultstring").item(0).getFirstChild().getNodeValue();
