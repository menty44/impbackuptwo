...
public class Get_dtickets_void2{
  ...
  public static void main(String[] args) {
    ...
    try {
        ...
        String reason_label = "PB PRINT";
        String IDUser = "225";
        String reason_comment = "testing impala";
        String distributorSecretKey = "de544d61zekhe6fgkezuf64e69effztd";
        
        String fred =  IDReseller + IDTransaction + IDUser + distributorSecretKey + reason_comment + reason_label;
        ...
        */
		...
		be.addChildElement("reason_comment").addTextNode(reason_comment).setAttribute("xsi:type","xsd:string");
		be.addChildElement("reason_label").addTextNode(reason_label).setAttribute("xsi:type","xsd:int");
