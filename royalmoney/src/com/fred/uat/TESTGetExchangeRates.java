...
public class TESTGetExchangeRates {
	...
	private static SOAPMessage createSoapRequest() throws Exception{
		 ...
		 SOAPPart soapPart = soapMessage.getSOAPPart();
    	         ...
    	         soapEnvelope.addNamespaceDeclaration("end", "http://tempuri.org/RMGetExchangeRates");
		 ...
		 SOAPElement soapElement = soapBody.addChildElement("GetExchReQ", "end");
